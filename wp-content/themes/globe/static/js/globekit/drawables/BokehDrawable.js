...
GK.BokehDrawable = function(){
    ...
    this.init = function() {
        ...
        texture1 = GK.TextureManager.loadTexture("/wp-content/themes/globe/static/img/texture/bokeh1.png", true, gl.CLAMP_TO_EDGE, gl.CLAMP_TO_EDGE);
        texture2 = GK.TextureManager.loadTexture("/wp-content/themes/globe/static/img/texture/bokeh2.png", true, gl.CLAMP_TO_EDGE, gl.CLAMP_TO_EDGE);
