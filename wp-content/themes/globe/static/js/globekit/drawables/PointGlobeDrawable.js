...
GK.PointGlobeDrawable = function(){
    ...
    this.init = function() {
        ...
        texture = GK.TextureManager.loadTexture("/wp-content/themes/globe/static/img/texture/dot.png", true, gl.CLAMP_TO_EDGE, gl.CLAMP_TO_EDGE);
        noiseTexture = GK.TextureManager.loadTexture("/wp-content/themes/globe/static/img/texture/clouds.png", true, gl.REPEAT, gl.REPEAT);
        return this;
    }
