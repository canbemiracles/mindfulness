...
<div class="topbar">
	<div class="container"><ul class="info-area">
						<li><label style="Font-weight:bold;">Email Id:</label> giri.manish.90@gmail.com</li>&nbsp;|&nbsp;
						<li><label style="Font-weight:bold;">Contact No:</label> +917828589617</li>
						
					</ul></div></div>
<div class="logo">
	<div class="container"><div id="custom-logo"><a href="/"><img src="http://mindfulness.nitishgarg.org/wp-content/uploads/2018/07/Без-имени-2-2.png"></a></div></div></div>
...
<div id="calendar-events">
	<div id="custom-logo-img"><img src="http://mindfulness.nitishgarg.org/wp-content/uploads/2018/07/Без-имени-2-1-1.png" /></div>
